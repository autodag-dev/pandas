...
- :func:`read_sas` now raises an informative ``ValueError`` for a SAS7BDAT file declaring more columns than its column-attribute or column-name subheaders describe, instead of a bare ``IndexError`` from the middle of the reader (:issue:`68065`)
