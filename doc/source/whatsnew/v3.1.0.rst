...
- Performance improvement in :meth:`RangeIndex.isin` when query values are small relative to the index length, by bypassing full integer array allocation and evaluating mathematically
