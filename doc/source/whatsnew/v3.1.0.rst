...
- Fixed bug in comparisons involving array-like objects (e.g., :class:`Series`, :class:`Index`, or :class:`DataFrame`) containing ``pd.NA``. These now return ``pd.NA`` instead of ``False`` (:issue:`63328`)
