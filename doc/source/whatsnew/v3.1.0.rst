...
- Bug in :class:`Index` constructor raising ``NotImplementedError`` for numpy fixed-width bytes (``|S``) dtypes (e.g. from a :class:`Series`) instead of converting to object (:issue:`57645`)
