...
- Bug in :meth:`Index.set_names`, :meth:`DataFrame.rename_axis`, and :meth:`Series.rename_axis` raising a ``ValueError`` when passing a hashable tuple (or other hashable, non-list iterable) name to a 1-dimensional index (:issue:`66656`)
