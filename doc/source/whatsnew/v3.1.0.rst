...
- Bug in :class:`Timedelta` and :class:`tseries.offsets.Tick` when dividing by a value greater than its :attr:`tseries.offsets.Tick.n`, that incorrectly returning zero instead of using a higher resolution offset (:issue:`57264`)
