...
- Bug when constructing or casting to a :class:`CategoricalDtype` silently converted values to missing values when their dtype differed from the categories dtype but the values were castable to it (:issue:`66688`)
-
