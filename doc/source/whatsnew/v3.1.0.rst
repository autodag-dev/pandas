...
- :meth:`Series.skew`, :meth:`Series.kurt`, :meth:`DataFrame.skew`, :meth:`DataFrame.kurt`, :meth:`.Rolling.skew`, :meth:`.Rolling.kurt`, :meth:`.Expanding.skew`, :meth:`.Expanding.kurt`, :meth:`.SeriesGroupBy.skew`, :meth:`.SeriesGroupBy.kurt`, :meth:`.DataFrameGroupBy.skew`, and :meth:`.DataFrameGroupBy.kurt` now accept a ``bias`` parameter to compute the biased (population) statistic instead of the default bias-corrected (sample) statistic, matching the behavior of ``scipy.stats.skew`` and ``scipy.stats.kurtosis`` (:issue:`54556`)
