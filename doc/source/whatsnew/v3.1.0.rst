...
- Bug in :meth:`Series.__finalize__` not unconditionally propagating the ``name`` attribute when subclassing, causing subclasses to lose their name during operations like fancy indexing (:issue:`61491`)
