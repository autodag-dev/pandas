...
- :func:`read_sas` now raises an informative ``ValueError`` for a SAS7BDAT file with a page claiming more rows than it has room for, instead of reading off the end of the page and failing with an internal error (:issue:`68067`, :issue:`68088`)
