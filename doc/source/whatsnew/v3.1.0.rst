...
- Bug in boolean-mask setitem, :meth:`Series.where`, :meth:`Series.mask`, and :meth:`Series.combine_first` aborting the Python process (``SIGABRT``) when applied to an :class:`ArrowDtype` column with null type (apache/arrow#47447, fixed in PyArrow 25.0.0) (:issue:`66703`)
