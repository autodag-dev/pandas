...
- Bug in :meth:`DataFrame.min`, :meth:`DataFrame.max`, and :meth:`DataFrame.agg` with ``axis=1`` on an empty DataFrame whose columns share a datetime-like dtype returning ``float64`` instead of preserving that dtype (:issue:`32802`)
