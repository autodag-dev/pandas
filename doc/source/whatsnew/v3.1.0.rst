...
- Bug in :meth:`Series.astype` with a :class:`CategoricalDtype` silently converting values to missing values when their dtype differed from the categories dtype but the values were castable to it (:issue:`66688`)
-
