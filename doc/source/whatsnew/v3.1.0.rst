...
- Fixed bug in :meth:`DataFrame.convert_dtypes` and :meth:`Series.convert_dtypes` with ``dtype_backend="pyarrow"`` where object columns containing lists or dicts were not converted to :class:`ArrowDtype` (:issue:`65034`)
