...
- Bug in :func:`merge` where merging on a column with a ``NaN`` name produced spurious duplicate columns with suffixes instead of recognizing the shared key (:issue:`65899`)
