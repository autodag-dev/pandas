...
- Bug in :meth:`RangeIndex.symmetric_difference` returning the result in descending order instead of sorted when operating against an empty :class:`RangeIndex` (:issue:`68264`)
