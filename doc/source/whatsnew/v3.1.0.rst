...
- Deprecated silent alignment on arithmetic operations between :class:`Series` and :class:`DataFrame` with incomparable ``MultiIndexes``. Please align ``MultiIndexes`` manually. (:issue:`25891`)
