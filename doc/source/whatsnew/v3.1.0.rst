...
- Bug in NumPy ufuncs on :class:`StringArray` returning ``object`` dtype instead of inferring an appropriate extension dtype, and on PyArrow-backed string arrays not preserving :class:`StringDtype` for string results (:issue:`40800`)
