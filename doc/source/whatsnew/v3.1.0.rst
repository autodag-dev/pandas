...
- Bug in :meth:`DataFrame.reindex` and :meth:`DataFrame.reindex_like` incorrectly applying ``method`` to columns when both axes were passed, producing incorrect values or raising ``TypeError`` (:issue:`31002`)
