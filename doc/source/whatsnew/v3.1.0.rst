...
- :meth:`Series.skew`, :meth:`Series.kurt`, :meth:`DataFrame.skew`, :meth:`DataFrame.kurt`, :meth:`.Rolling.skew`, :meth:`.Rolling.kurt`, :meth:`.Expanding.skew`, :meth:`.Expanding.kurt`, :meth:`.SeriesGroupBy.skew`, :meth:`.SeriesGroupBy.kurt`, :meth:`.DataFrameGroupBy.skew`, and :meth:`.DataFrameGroupBy.kurt` now accept a ``bias`` parameter to skip the default correction for statistical bias and return the raw (uncorrected) value, matching the behavior of ``scipy.stats.skew`` and ``scipy.stats.kurtosis`` (:issue:`54556`)
