...
- The NumPy header location can now be supplied at build time through the ``numpy-include-dir`` Meson property, which is needed when cross-compiling and the target's NumPy cannot be imported on the build machine (:issue:`55305`, :issue:`62883`)
