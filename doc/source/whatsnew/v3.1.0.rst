...
- Bug in :meth:`DataFrame.pivot` and :func:`pivot` raising ``TypeError`` or ``ValueError`` when ``index`` or ``columns`` was given as an array-like of column labels, e.g. a ``numpy.ndarray``, :class:`Index`, or :class:`Series` (:issue:`35785`)
